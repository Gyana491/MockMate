...
export default function AuthPage() {
  return (
    <section className="min-h-screen bg-neutral-900 text-white pt-20 relative overflow-hidden">
      {/* Background Elements */}
      <div className="absolute top-20 -left-60 w-96 h-96 bg-purple-500/10 rounded-full blur-3xl animate-pulse"></div>
      <div className="absolute bottom-20 -right-60 w-96 h-96 bg-indigo-500/10 rounded-full blur-3xl animate-pulse delay-200"></div>
